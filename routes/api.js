...
const Controllers = {
	v_2_2: {
		...
		EBCCValidationHeader: require(_directory_base + '/app/v2.2/Http/Controllers/EBCCValidationHeaderController.js'),
	},
	v_2_1: {
...
module.exports = (app) => {
	...
	app.post('/api/v2.2/ebcc/validation/header', Middleware.v_2_0.VerifyToken, Controllers.v_2_2.EBCCValidationHeader.create);
	...
	app.post('/api/v2.1/ebcc/validation/detail', Middleware.v_2_0.VerifyToken, Controllers.v_2_1.EBCCValidationDetail.create);

	// EBCC Validation Header
	app.post('/api/v2.1/ebcc/validation/header', Middleware.v_2_0.VerifyToken, Controllers.v_2_1.EBCCValidationHeader.create);
